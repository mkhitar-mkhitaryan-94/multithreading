...
public class Main5 {
    ...
    public static void main(String[] args) throws InterruptedException {
        initMap();
        Thread t1 = new Thread(new Main3.Reader(), "Reader 1");
        Thread t11 = new Thread(new Main3.Reader(), "Reader 2");
        Thread t12 = new Thread(new Main3.Reader(), "Reader 3");
        Thread t13 = new Thread(new Main3.Reader(), "Reader 4");
        Thread t14 = new Thread(new Main3.Reader(), "Reader 5");
        Thread t15 = new Thread(new Main3.Reader(), "Reader 6");
        Thread t2 = new Thread(new Main3.WriterA());
        Thread t3 = new Thread(new Main3.WriterB());
        t1.start();
        t11.start();
        t12.start();
        t13.start();
